function [coords, positions, paths, speed, destinations, P_move] = gerar_positions(m_T, r, raio_1, x_center_1, y_center_1, raio_2, x_center_2, y_center_2, raio_3, x_center_3, y_center_3, raio_4, x_center_4, y_center_4, raio_5, x_center_5, y_center_5, xPU, yPU, xFC)

    speed = 5 * rand(m_T, 1);  % Velocidades aleatórias para cada SU
    P_move = 0.5; % Probabilidade de movimento para cada sensor

    % Gerar posições iniciais dentro de um círculo de raio 'area_size'
    ...
    positions = [x; y]';  % Matriz de posições iniciais (N x 2)
    coords = [x; y];
    ...
    scatter(x, y, 10, 'bo', 'MarkerFaceColor', 'b', 'LineWidth', 1.5);
